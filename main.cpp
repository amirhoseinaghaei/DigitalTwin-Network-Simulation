...
int main()
{
    ...
    PhysicalSystem* p1 = new Mobile_Device{1 , 20, 80};
    ...
    std::thread th1(&PS_BS_Connection::Send_PS, std::ref(ps_bs), 10, p1, 0);
    // std::thread th2(&PhysicalSystem::display_information, p1);
